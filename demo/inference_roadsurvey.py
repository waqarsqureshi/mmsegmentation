...
def main() :
    ...
    parser.add_argument("-config", "--config", type=str, help="path to config file", default="/home/pms/mmsegmentation/configs/deeplabv3plus/deeplabv3plus_r50b-d8_512x512_160k_roadsurvey.py")
    parser.add_argument("-checkpoint", "--checkpoint", type=str, help="path to checkpoint file", default="/home/pms/mmsegmentation/work_dirs/deeplabv3plus_r50b-d8_512x512_160k_roadsurvey/latest.pth")
    ...
    for file in files:
        orig = cv2.imread(file) # Read the image using opencv format
